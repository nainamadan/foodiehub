    ...
    <div className="footer" id="footer">
      <div className="footer-content">
        <div className="footer-content-left">
          ...
          <p>
            FoodieHub is a modern restaurant application that connects food
            ...
            navigation, FoodieHub makes dining convenient, enjoyable, and
            hassle-free for customers while helping restaurants serve better.
          </p>
          <div className="footer-social-icons">
            <a href="https://www.github.com/nainamadan" target="_blank">
              {" "}
              <img
                src={assets.github}
                alt=""
        ...
        <div className="footer-content-right">
          ...
          <ul>
            ...
            <li>contact@nainamadan.com</li>
          </ul>
        </div>
      </div>
      <hr />
      <p>Developed by Naina Madan</p>
      <p className="footer-copyright">
        Copyright 2025 @ foodiehub.com - All Right Reserved.
      </p>
    </div>
  );
};
